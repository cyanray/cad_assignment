...
Public Function AddLine(StartPoint As Point3, EndPoint As Point3)
    Set AddLine = m_Block.AddLine(StartPoint.ToArray(), EndPoint.ToArray())
End Function

Public Function AddLineXYZXYZ(x1 as double, y1 as double, z1 as double, x2 as double, y2 as double, z2 as double)
...
Public Function AddSpline(Points As Point3Collection, StartTangent As Point3, EndTangent As Point3)
